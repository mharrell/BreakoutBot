...
# Skip 5M and 10M (already have data). Run remaining 10 checkpoints at 10 games each.
$names = @(
    "PPO_124", "PPO_124", "PPO_124", "PPO_124",
    "PPO_126", "PPO_126", "PPO_126", "PPO_126", "PPO_126", "PPO_126"
)
$labels = @(
    "15M", "19.2M_best", "20M", "25M_final",
...
for ($idx = 0; $idx -lt $total; $idx++) {
    ...
    $output = & python -u verify_split_watcher_notiming.py --model $path --games 10 2>&1
