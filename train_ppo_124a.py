"""
PPO_124a — Experiment 36a: Multi-seed replication of PPO_124

Identical config to PPO_124 (ProximityReward scale=0.05, 25M steps).
Different random seed (1241) to test reproducibility of the reactivity result.
...
if __name__ == "__main__":
    print(f"{RUN_NAME} — Experiment 36a: Multi-seed replication of PPO_124")
    ...
    memorization_callback = MemorizationCheckCallback(
        ...
        summary_lines=[
            f"PPO_124a — Experiment 36a: Multi-seed replication of PPO_124",
