...
def start_writer(frame, temp_video, playback_fps):
    h, w = frame.shape[:2]
...
if __name__ == "__main__":
    ...
    writer = start_writer(first_frame, TEMP_VIDEO, PLAYBACK_FPS)
    ...
    while True:
        ...
        if done[0]:
            if lives == 0:
                ...
                writer = start_writer(next_frame, TEMP_VIDEO, PLAYBACK_FPS)
