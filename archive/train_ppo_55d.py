"""
PPO_55d — UPPER PROBE ENTROPY CONTINUATION (ent_coef: 0.006 → 0.02, 4.17×)
...
VARIANTS (all from PPO_55 step 10M, all Y-only, cooldown=30, prob=10%):
  ...
  PPO_55b: ent_coef = 0.025  (4.17×, moderate)    ← THIS SCRIPT
...
ENT_COEF_PRE = 0.006
ENT_COEF_POST = 0.025    # upper sweet spot probe — 4.17× increase
...
if __name__ == "__main__":
    ...
    label = {0.010: "MILD", 0.025: "MODERATE", 0.040: "AGGRESSIVE"}.get(ENT_COEF_POST, "CUSTOM")
    ...
    print(f"  Variants:       55a={0.010} (mild)  55b={0.025} (moderate)  55c={0.040} (aggressive)")
