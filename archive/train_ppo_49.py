"""
PPO_49 — ALE Experiment 3: X-Mirror Ball (60%)
...
At 60% per frame, the ball reflects left↔right frequently. A stationary
paddle on one side misses the ball when it mirrors to the opposite side.
The policy MUST track horizontally to succeed.

Design:
  - Training:  ALE/Breakout-v5 + ALEBreakoutXMirror(mirror_prob=0.60)
               Ball X reflects across center on 60% of mid-flight frames.
...
def make_training_env():
    """ALE/Breakout-v5 with X-mirror at 60%.
...
if __name__ == "__main__":
    ...
    memorization_callback = MemorizationCheckCallback(
        ...
        summary_lines=[
            f"PPO_49 — ALE Experiment 3 (X-mirror at 60%)",
