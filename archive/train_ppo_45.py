...
with ball teleportation on paddle bounce (15% probability) to force the
...
Design:
  - Training:  ALE/Breakout-v5 + ALEBreakoutRandomized(teleport_prob=0.30)
               Ball teleports to random (X,Y) on 15% of paddle bounces.
...
def make_training_env():
    """ALE/Breakout-v5 with ball teleportation on 15% of paddle bounces.
