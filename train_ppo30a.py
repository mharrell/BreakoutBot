...
No sticky actions. Trains for 100M steps from scratch.
When complete, PPO_30b loads this checkpoint and adds sticky actions.
...
print(f"Next: run train_ppo30b.py to start the sticky-action phase.")
env.close()
eval_env.close()
