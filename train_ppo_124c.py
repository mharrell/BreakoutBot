"""
PPO_124c — Experiment 36c: Multi-seed replication of PPO_124

Identical config to PPO_124 (ProximityReward scale=0.05, 25M steps).
Different random seed (1243) to test reproducibility of the reactivity result.

See train_ppo_124.py for full design rationale.
"""
import os
import numpy as np
import glob
...
if __name__ == "__main__":
    print(f"{RUN_NAME} — Experiment 36c: Multi-seed replication of PPO_124")
    ...
    memorization_callback = MemorizationCheckCallback(
        ...
        summary_lines=[
            f"PPO_124c — Experiment 36c: Multi-seed replication of PPO_124",
